...
package local_project.curated_v2_0_2;
...
/**
 * Job: CURATED_V2 Purpose: <br>
 * Description: Realiza ingestão dos dados AdventureWorks. <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class CURATED_V2 implements TalendJob {
...
public String getPath_harm(){
	...
	private final String jobName = "CURATED_V2";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(CURATED_V2.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
			...
			public void tAdvancedHash_HAddress_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_CURATED_V2 = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_CURATED_V2 = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LOCAL_PROJECT_CURATED_V2.length) {
				if(length < 1024 && commonByteArray_LOCAL_PROJECT_CURATED_V2.length == 0) {
   					commonByteArray_LOCAL_PROJECT_CURATED_V2 = new byte[1024];
				} else {
   					commonByteArray_LOCAL_PROJECT_CURATED_V2 = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LOCAL_PROJECT_CURATED_V2, 0, length);
			strReturn = new String(commonByteArray_LOCAL_PROJECT_CURATED_V2, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_LOCAL_PROJECT_CURATED_V2, 0, length);
			strReturn = new String(commonByteArray_LOCAL_PROJECT_CURATED_V2, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_PROJECT_CURATED_V2) {
        	...
        	try {
        		...
        		int length = 0;
			        ...
			        this.QuantitySold = dis.readShort();
					
			        this.UnitPrice = dis.readFloat();
					
						this.TotalSold = (BigDecimal) dis.readObject();
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// short
		            	...
		            	dos.writeShort(this.QuantitySold);
					...
					// BigDecimal
       			    	...
       			    	dos.writeObject(this.TotalSold);
...
public static class SalesV2Struct implements routines.system.IPersistableRow<SalesV2Struct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_CURATED_V2 = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_CURATED_V2 = new byte[0];
        	...
        	try {
        		...
        		int length = 0;
					...
					this.SalesPerson = readString(dis);
						...
						this.SalesPosition = readInteger(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.SalesPosition,dos);
    ...
    public String toString() {
		...
		sb.append(",Region="+Region);
		sb.append(",SalesPerson="+SalesPerson);
		sb.append(",SalesPosition="+String.valueOf(SalesPosition));
     ...
     * Compare keys
     */
    public int compareTo(SalesV2Struct other) {
...
public static class ProductsByRegionStruct implements routines.system.IPersistableRow<ProductsByRegionStruct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_CURATED_V2 = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_CURATED_V2 = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(ProductsByRegionStruct other) {
...
public static class ProductsSoldStruct implements routines.system.IPersistableRow<ProductsSoldStruct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_CURATED_V2 = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_CURATED_V2 = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(ProductsSoldStruct other) {
...
SalesV2Struct SalesV2 = new SalesV2Struct();
ProductsByRegionStruct ProductsByRegion = new ProductsByRegionStruct();
row3Struct row3 = new row3Struct();
ProductsSoldStruct ProductsSold = new ProductsSoldStruct();
...
// ------------
	...
	class AggOperationStruct_tAggregateRow_1 { // G_OutBegin_AggR_100
	    ...
	    public boolean hashCodeDirty = true;
    				...
    				String Region;
    				String SalesPerson;BigDecimal Amount_sum;
 ...
 */
	...
	currentComponent="tAggregateRow_2_AGGOUT";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"ProductsByRegion");
					}
...
// ------------
	...
	class AggOperationStruct_tAggregateRow_2 { // G_OutBegin_AggR_100
	    ...
	    public boolean hashCodeDirty = true;
    				...
    				String City;
    				String ProductName;
         			short QuantitySold_sum;
         			float UnitPrice_first;BigDecimal TotalSold_sum;
 ...
 */
	...
	currentComponent="tAggregateRow_3_AGGOUT";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"ProductsSold");
					}
...
HCustomerStruct HCustomerDefault = new HCustomerStruct();
		...
		org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<HAddressStruct> tHash_Lookup_HAddress = (org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<HAddressStruct>) 
				((org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<HAddressStruct>) 
					globalMap.get( "tHash_Lookup_HAddress" ))
					;					
					
	

HAddressStruct HAddressHashKey = new HAddressStruct();
HAddressStruct HAddressDefault = new HAddressStruct();
// ###############################        
...
ProductsByRegionStruct ProductsByRegion_tmp = new ProductsByRegionStruct();
ProductsSoldStruct ProductsSold_tmp = new ProductsSoldStruct();
// ###############################
					...
					columnIndexWithD_tFileInputDelimited_3 = 24;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								HSalesOrder.UnitPrice = ParserUtils.parseTo_float(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_3) {
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"UnitPrice", "HSalesOrder", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
    							
						} else {						
							
								rowstate_tFileInputDelimited_3.setException(new RuntimeException("Value is empty for column : 'UnitPrice' in 'HSalesOrder' connection, value is invalid or this column should be nullable or have a default value."));
					...
					columnIndexWithD_tFileInputDelimited_3 = 25;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								HSalesOrder.UnitPriceDiscount = ParserUtils.parseTo_float(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_3) {
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"UnitPriceDiscount", "HSalesOrder", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
    							
						} else {						
							
								rowstate_tFileInputDelimited_3.setException(new RuntimeException("Value is empty for column : 'UnitPriceDiscount' in 'HSalesOrder' connection, value is invalid or this column should be nullable or have a default value."));
	...
	currentComponent="tMap_1";
        ...
        // # Input tables (lookups)
		  ...
		  boolean mainRowRejected_tMap_1 = false;
 					    ...
 					    boolean forceLoopHCustomer = false;
 							...
 							HCustomerStruct HCustomerObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
								  ...
								  if(hasCasePrimitiveKeyWithNull_tMap_1 || !tHash_Lookup_HCustomer.hasNext()) { // G_TM_M_090
							...
							HCustomerStruct HCustomer = null;
								...
								while ((tHash_Lookup_HCustomer != null && tHash_Lookup_HCustomer.hasNext()) || forceLoopHCustomer) { // G_TM_M_043

								
									 // CALL close loop of lookup 'HCustomer'
				...
				///////////////////////////////////////////////
				// Starting Lookup Table "HAddress" 
				///////////////////////////////////////////////
 					    ...
 					    boolean forceLoopHAddress = false;
       		  	    	
       		  	    	
 							HAddressStruct HAddressObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
	                        		    	...
	                        		    	Object exprKeyValue_HAddress__AddressID = HSalesOrder.ShippingAddressID ;
	                        		    	if(exprKeyValue_HAddress__AddressID == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			HAddressHashKey.AddressID = (int)(Integer) exprKeyValue_HAddress__AddressID;
                        		    		}
                        		    		

								
		                        	HAddressHashKey.hashCodeDirty = true;
		  							...
		  							tHash_Lookup_HAddress.lookup( HAddressHashKey );
				           		...
				           		if(tHash_Lookup_HAddress != null && tHash_Lookup_HAddress.getCount(HAddressHashKey) > 1) { // G 071
			  							
			  						
									 		
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'HAddress' and it contains more one result from keys :  HAddress.AddressID = '" + HAddressHashKey.AddressID + "'");
								} // G 071
							

							HAddressStruct HAddress = null;
                    		  	 
							   
                    		  	 
	       		  	    	HAddressStruct fromLookup_HAddress = null;
							HAddress = HAddressDefault;
										 
							
								 
							
							
								if (tHash_Lookup_HAddress !=null && tHash_Lookup_HAddress.hasNext()) { // G 099
								
							
								
								fromLookup_HAddress = tHash_Lookup_HAddress.next();
							...
							if(fromLookup_HAddress != null) {
								HAddress = fromLookup_HAddress;
							}
...
// # Output table : 'Sales'
Sales_tmp.OrderDate = HSalesOrder.OrderDate ;
Sales_tmp.OnlineOrderFlag = HSalesOrder.OnlineOrderFlag ;
Sales_tmp.Region = HAddress.CountryRegion ;
Sales_tmp.SalesPerson = HCustomer.SalesPerson ;
Sales_tmp.Amount = HSalesOrder.TotalDue ;
Sales = Sales_tmp;

// # Output table : 'ProductsByRegion'
ProductsByRegion_tmp.OrderDate = HSalesOrder.OrderDate ;
ProductsByRegion_tmp.Region = HAddress.CountryRegion ;
ProductsByRegion_tmp.StateProvince = HAddress.StateProvince ;
ProductsByRegion_tmp.City = HAddress.City ;
ProductsByRegion_tmp.ProductName = HProduct.Name ;
ProductsByRegion_tmp.QuantitySold = HSalesOrder.OrderQty ;
ProductsByRegion_tmp.UnitPrice = HSalesOrder.UnitPrice ;
ProductsByRegion_tmp.TotalSold = HSalesOrder.LineTotal ;
ProductsByRegion = ProductsByRegion_tmp;

// # Output table : 'ProductsSold'
ProductsSold_tmp.OrderDate = HSalesOrder.OrderDate ;
ProductsSold_tmp.ProductCategory = HProduct.ProductCategoryName ;
ProductsSold_tmp.ProductModel = HProduct.ProductModelName ;
ProductsSold_tmp.ProductName = HProduct.Name ;
ProductsSold_tmp.SalesPerson = HCustomer.SalesPerson ;
ProductsSold_tmp.Region = HAddress.CountryRegion ;
ProductsSold_tmp.QuantitySold = HSalesOrder.OrderQty ;
ProductsSold_tmp.UnitPrice = HSalesOrder.UnitPrice ;
ProductsSold_tmp.TotalSold = HSalesOrder.LineTotal ;
ProductsSold = ProductsSold_tmp;
// ###############################
...
if(Sales.SalesPerson == null){
	finder_tUniqRow_1.SalesPerson = null;
}else{
	finder_tUniqRow_1.SalesPerson = Sales.SalesPerson.toLowerCase();
}
...
if(Sales.SalesPerson == null){
	...
	new_tUniqRow_1.SalesPerson = Sales.SalesPerson.toLowerCase();
}
new_tUniqRow_1.Amount = Sales.Amount;
	...
	row1 = new row1Struct();
}row1.OrderDate = Sales.OrderDate;			row1.OnlineOrderFlag = Sales.OnlineOrderFlag;			row1.Region = Sales.Region;			row1.SalesPerson = Sales.SalesPerson;			row1.Amount = Sales.Amount;					
...
operation_finder_tAggregateRow_1.OrderDate = row1.OrderDate;
			operation_finder_tAggregateRow_1.OnlineOrderFlag = row1.OnlineOrderFlag;
			operation_finder_tAggregateRow_1.Region = row1.Region;
	...
	if(operation_result_tAggregateRow_1 == null) { // G_OutMain_AggR_001
		...
		hash_tAggregateRow_1.put(operation_result_tAggregateRow_1, operation_result_tAggregateRow_1);
					...
					if(operation_result_tAggregateRow_1.Amount_sum == null) {
						operation_result_tAggregateRow_1.Amount_sum = new BigDecimal(0).setScale(4);
					}
...
// Start of branch "ProductsByRegion"
if(ProductsByRegion != null) { 
...
operation_finder_tAggregateRow_2.OrderDate = ProductsByRegion.OrderDate;
			operation_finder_tAggregateRow_2.Region = ProductsByRegion.Region;
			operation_finder_tAggregateRow_2.StateProvince = ProductsByRegion.StateProvince;
			operation_finder_tAggregateRow_2.City = ProductsByRegion.City;
			operation_finder_tAggregateRow_2.ProductName = ProductsByRegion.ProductName;
	...
	if(operation_result_tAggregateRow_2 == null) { // G_OutMain_AggR_001
		...
		hash_tAggregateRow_2.put(operation_result_tAggregateRow_2, operation_result_tAggregateRow_2);
						...
						operation_result_tAggregateRow_2.QuantitySold_sum += ProductsByRegion.QuantitySold;
					
				if(isFirstAdd_tAggregateRow_2 ) {
					operation_result_tAggregateRow_2.UnitPrice_first = ProductsByRegion.UnitPrice;
				}
				
					if(operation_result_tAggregateRow_2.TotalSold_sum == null) {
						operation_result_tAggregateRow_2.TotalSold_sum = new BigDecimal(0).setScale(6);
					}
					operation_result_tAggregateRow_2.TotalSold_sum = operation_result_tAggregateRow_2.TotalSold_sum.add(
						new BigDecimal(
							String.valueOf(
								ProductsByRegion.TotalSold
							)
						)
					);
...
} // End of branch "ProductsByRegion"




// Start of branch "ProductsSold"
...
operation_finder_tAggregateRow_3.OrderDate = ProductsSold.OrderDate;
			operation_finder_tAggregateRow_3.ProductCategory = ProductsSold.ProductCategory;
			operation_finder_tAggregateRow_3.ProductModel = ProductsSold.ProductModel;
			operation_finder_tAggregateRow_3.ProductName = ProductsSold.ProductName;
			operation_finder_tAggregateRow_3.SalesPerson = ProductsSold.SalesPerson;
			operation_finder_tAggregateRow_3.Region = ProductsSold.Region;
	...
	if(operation_result_tAggregateRow_3 == null) { // G_OutMain_AggR_001
		...
		operation_result_tAggregateRow_3.OrderDate = operation_finder_tAggregateRow_3.OrderDate;
				operation_result_tAggregateRow_3.ProductCategory = operation_finder_tAggregateRow_3.ProductCategory;
				operation_result_tAggregateRow_3.ProductModel = operation_finder_tAggregateRow_3.ProductModel;
				operation_result_tAggregateRow_3.ProductName = operation_finder_tAggregateRow_3.ProductName;
		...
		hash_tAggregateRow_3.put(operation_result_tAggregateRow_3, operation_result_tAggregateRow_3);
						...
						operation_result_tAggregateRow_3.QuantitySold_sum += ProductsSold.QuantitySold;
					
				if(isFirstAdd_tAggregateRow_3 ) {
					operation_result_tAggregateRow_3.UnitPrice_first = ProductsSold.UnitPrice;
				}
				
					if(operation_result_tAggregateRow_3.TotalSold_sum == null) {
						operation_result_tAggregateRow_3.TotalSold_sum = new BigDecimal(0).setScale(6);
					}
					operation_result_tAggregateRow_3.TotalSold_sum = operation_result_tAggregateRow_3.TotalSold_sum.add(
						new BigDecimal(
							String.valueOf(
...
} // End of branch "ProductsSold"



	
		} // close loop of lookup 'HCustomer' // G_TM_M_043
...
// # Lookup hashes releasing
					...
					if(tHash_Lookup_HAddress != null) {
						tHash_Lookup_HAddress.endGet();
					}
					globalMap.remove( "tHash_Lookup_HAddress" );
 ...
 */
	...
	currentComponent="tFileOutputDelimited_2";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"SalesV2");
					}
...
String fileName_tFileOutputDelimited_2 = "";
    fileName_tFileOutputDelimited_2 = (new java.io.File(context.path_cura+"Sales_Report_V2.csv")).getAbsolutePath().replace("\\","/");
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_2, false),"ISO-8859-15"));
                                    if(filetFileOutputDelimited_2.length()==0){
                                        ...
                                        outtFileOutputDelimited_2.write("SalesPerson");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
                                        outtFileOutputDelimited_2.write("SalesPosition");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
...
// ###############################
// # Outputs initialization
SalesV2Struct SalesV2_tmp = new SalesV2Struct();
// ###############################
 ...
 */
	...
	currentComponent="tAggregateRow_1_AGGIN";
            				    ...
            				    row2.Region = aggregated_row_tAggregateRow_1.Region;
...
// # Output table : 'SalesV2'
SalesV2_tmp.OrderDate = row2.OrderDate ;
SalesV2_tmp.OnlineOrderFlag = row2.OnlineOrderFlag ;
SalesV2_tmp.Region = row2.Region ;
SalesV2_tmp.SalesPerson = row2.SalesPerson ;
SalesV2_tmp.SalesPosition = Numeric.sequence("SalesPosition", 1, 1);
SalesV2_tmp.Amount = row2.Amount ;
SalesV2 = SalesV2_tmp;
// ###############################
...
if(SalesV2 != null) { 
	...
	currentComponent="tFileOutputDelimited_2";
                    ...
                    StringBuilder sb_tFileOutputDelimited_2 = new StringBuilder();
                            if(SalesV2.OrderDate != null) {
                        sb_tFileOutputDelimited_2.append(
                            FormatterUtils.format_Date(SalesV2.OrderDate, "dd-MM-yyyy")
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(SalesV2.OnlineOrderFlag != null) {
                        sb_tFileOutputDelimited_2.append(
                            SalesV2.OnlineOrderFlag
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(SalesV2.Region != null) {
                        sb_tFileOutputDelimited_2.append(
                            SalesV2.Region
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(SalesV2.SalesPerson != null) {
                        sb_tFileOutputDelimited_2.append(
                            SalesV2.SalesPerson
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(SalesV2.SalesPosition != null) {
                        sb_tFileOutputDelimited_2.append(
                                    FormatterUtils.format_Number(new java.math.BigDecimal(String.valueOf(SalesV2.SalesPosition)).toPlainString(), null, ',')
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                        sb_tFileOutputDelimited_2.append(
                                    FormatterUtils.format_Number(new java.math.BigDecimal(String.valueOf(SalesV2.Amount)).toPlainString(), null, ',')
                        );
 ...
 */
	...
	currentComponent="tFileOutputDelimited_2";
		...
		resourceMap.put("finish_tFileOutputDelimited_2", true);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"SalesV2");
			  	}
 ...
 */
	...
	currentComponent="tAggregateRow_2_AGGOUT";
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"ProductsByRegion");
			  	}
...
String fileName_tFileOutputDelimited_3 = "";
    fileName_tFileOutputDelimited_3 = (new java.io.File(context.path_cura+"ProductsByRegion_V2.csv")).getAbsolutePath().replace("\\","/");
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_3, false),"ISO-8859-15"));
                                    if(filetFileOutputDelimited_3.length()==0){
                                        ...
                                        outtFileOutputDelimited_3.write("ProductName");
                                            outtFileOutputDelimited_3.write(OUT_DELIM_tFileOutputDelimited_3);
                                        outtFileOutputDelimited_3.write("QuantitySold");
                                            outtFileOutputDelimited_3.write(OUT_DELIM_tFileOutputDelimited_3);
                                        outtFileOutputDelimited_3.write("UnitPrice");
                                            outtFileOutputDelimited_3.write(OUT_DELIM_tFileOutputDelimited_3);
                                        outtFileOutputDelimited_3.write("TotalSold");
 ...
 */
	...
	currentComponent="tAggregateRow_2_AGGIN";
            				    ...
            				    row3.OrderDate = aggregated_row_tAggregateRow_2.OrderDate;
            				    
            				    row3.Region = aggregated_row_tAggregateRow_2.Region;
            				    
            				    row3.StateProvince = aggregated_row_tAggregateRow_2.StateProvince;
            				    
            				    row3.City = aggregated_row_tAggregateRow_2.City;
            				    
            				    row3.ProductName = aggregated_row_tAggregateRow_2.ProductName;
            				    row3.QuantitySold = aggregated_row_tAggregateRow_2.QuantitySold_sum;
                                	
                                row3.UnitPrice = aggregated_row_tAggregateRow_2.UnitPrice_first;row3.TotalSold = aggregated_row_tAggregateRow_2.TotalSold_sum;
	...
	currentComponent="tFileOutputDelimited_3";
                    ...
                    StringBuilder sb_tFileOutputDelimited_3 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_3.append(
                            ...
                            sb_tFileOutputDelimited_3.append(OUT_DELIM_tFileOutputDelimited_3);
                        sb_tFileOutputDelimited_3.append(
                                    FormatterUtils.format_Number(new java.math.BigDecimal(String.valueOf(row3.QuantitySold)).toPlainString(), null, ',')
                        );
                            sb_tFileOutputDelimited_3.append(OUT_DELIM_tFileOutputDelimited_3);
                        sb_tFileOutputDelimited_3.append(
                                    FormatterUtils.format_Number(new java.math.BigDecimal(String.valueOf(row3.UnitPrice)).toPlainString(), null, ',')
                        );
                            sb_tFileOutputDelimited_3.append(OUT_DELIM_tFileOutputDelimited_3);
                            if(row3.TotalSold != null) {
                        sb_tFileOutputDelimited_3.append(
                                    FormatterUtils.format_Number(row3.TotalSold.setScale(6, java.math.RoundingMode.HALF_UP).toPlainString(), null, ',')
                        );
                            }
 ...
 */
	...
	currentComponent="tAggregateRow_3_AGGOUT";
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"ProductsSold");
			  	}
...
String fileName_tFileOutputDelimited_4 = "";
    fileName_tFileOutputDelimited_4 = (new java.io.File(context.path_cura+"ProductsSold_V2.csv")).getAbsolutePath().replace("\\","/");
                    ...
                    if(directory_tFileOutputDelimited_4 != null && directory_tFileOutputDelimited_4.trim().length() != 0) {
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_4, false),"ISO-8859-15"));
                                    if(filetFileOutputDelimited_4.length()==0){
                                        ...
                                        outtFileOutputDelimited_4.write("ProductCategory");
                                            outtFileOutputDelimited_4.write(OUT_DELIM_tFileOutputDelimited_4);
                                        outtFileOutputDelimited_4.write("ProductModel");
                                            outtFileOutputDelimited_4.write(OUT_DELIM_tFileOutputDelimited_4);
                                        outtFileOutputDelimited_4.write("ProductName");
                                            outtFileOutputDelimited_4.write(OUT_DELIM_tFileOutputDelimited_4);
                                        outtFileOutputDelimited_4.write("SalesPerson");
                                            outtFileOutputDelimited_4.write(OUT_DELIM_tFileOutputDelimited_4);
                                        outtFileOutputDelimited_4.write("Region");
                                            outtFileOutputDelimited_4.write(OUT_DELIM_tFileOutputDelimited_4);
                                        outtFileOutputDelimited_4.write("QuantitySold");
                                            outtFileOutputDelimited_4.write(OUT_DELIM_tFileOutputDelimited_4);
                                        outtFileOutputDelimited_4.write("UnitPrice");
                                            outtFileOutputDelimited_4.write(OUT_DELIM_tFileOutputDelimited_4);
                                        outtFileOutputDelimited_4.write("TotalSold");
 ...
 */
	...
	currentComponent="tAggregateRow_3_AGGIN";
            				    ...
            				    row4.OrderDate = aggregated_row_tAggregateRow_3.OrderDate;
            				    
            				    row4.ProductCategory = aggregated_row_tAggregateRow_3.ProductCategory;
            				    
            				    row4.ProductModel = aggregated_row_tAggregateRow_3.ProductModel;
            				    
            				    row4.ProductName = aggregated_row_tAggregateRow_3.ProductName;
            				    
            				    row4.SalesPerson = aggregated_row_tAggregateRow_3.SalesPerson;
            				    
            				    row4.Region = aggregated_row_tAggregateRow_3.Region;
            				    row4.QuantitySold = aggregated_row_tAggregateRow_3.QuantitySold_sum;
                                	
                                row4.UnitPrice = aggregated_row_tAggregateRow_3.UnitPrice_first;row4.TotalSold = aggregated_row_tAggregateRow_3.TotalSold_sum;
	...
	currentComponent="tFileOutputDelimited_4";
                    ...
                    StringBuilder sb_tFileOutputDelimited_4 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_4.append(
                            FormatterUtils.format_Date(row4.OrderDate, "dd-MM-yyyy")
                        );
                            }
                            sb_tFileOutputDelimited_4.append(OUT_DELIM_tFileOutputDelimited_4);
                            if(row4.ProductCategory != null) {
                        sb_tFileOutputDelimited_4.append(
                            row4.ProductCategory
                        );
                            }
                            sb_tFileOutputDelimited_4.append(OUT_DELIM_tFileOutputDelimited_4);
                            if(row4.ProductModel != null) {
                        sb_tFileOutputDelimited_4.append(
                            row4.ProductModel
                        );
                            }
                        ...
                        sb_tFileOutputDelimited_4.append(
                            ...
                            sb_tFileOutputDelimited_4.append(OUT_DELIM_tFileOutputDelimited_4);
                        sb_tFileOutputDelimited_4.append(
                                    FormatterUtils.format_Number(new java.math.BigDecimal(String.valueOf(row4.QuantitySold)).toPlainString(), null, ',')
                        );
                            sb_tFileOutputDelimited_4.append(OUT_DELIM_tFileOutputDelimited_4);
                        sb_tFileOutputDelimited_4.append(
                                    FormatterUtils.format_Number(new java.math.BigDecimal(String.valueOf(row4.UnitPrice)).toPlainString(), null, ',')
                        );
                            sb_tFileOutputDelimited_4.append(OUT_DELIM_tFileOutputDelimited_4);
                            if(row4.TotalSold != null) {
                        sb_tFileOutputDelimited_4.append(
                                    FormatterUtils.format_Number(row4.TotalSold.setScale(6, java.math.RoundingMode.HALF_UP).toPlainString(), null, ',')
                        );
                            }
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_HProduct";
		...
		int tos_count_tAdvancedHash_HProduct = 0;
			   		...
			   		// linked node: tMap_1 - inputs:(HSalesOrder,HProduct,HCustomer,HAddress) outputs:(DataSciense,Sales,ProductsByRegion,ProductsSold)
...
public static class HAddressStruct implements routines.system.IPersistableComparableLookupRow<HAddressStruct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_CURATED_V2 = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_CURATED_V2 = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final HAddressStruct other = (HAddressStruct) obj;
	...
	public void copyDataTo(HAddressStruct other) {
	...
	public void copyKeysDataTo(HAddressStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(HAddressStruct other) {
...
public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try {
		...
		HAddressStruct HAddress = new HAddressStruct();
	...
	/**
	 * [tAdvancedHash_HAddress begin ] start
	 */
		...
		ok_Hash.put("tAdvancedHash_HAddress", false);
		start_Hash.put("tAdvancedHash_HAddress", System.currentTimeMillis());
		
	
	currentComponent="tAdvancedHash_HAddress";

	
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"HAddress");
					}
				
		int tos_count_tAdvancedHash_HAddress = 0;
		

			   		// connection name:HAddress
			   		// source node:tFileInputDelimited_1 - inputs:(after_tFileInputDelimited_3) outputs:(HAddress,HAddress) | target node:tAdvancedHash_HAddress - inputs:(HAddress) outputs:()
			   		// linked node: tMap_1 - inputs:(HSalesOrder,HProduct,HCustomer,HAddress) outputs:(DataSciense,Sales,ProductsByRegion,ProductsSold)
			   
			   		org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE matchingModeEnum_HAddress = 
			   			org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE.UNIQUE_MATCH;
			   			
			   
	   			org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<HAddressStruct> tHash_Lookup_HAddress =org.talend.designer.components.lookup.memory.AdvancedMemoryLookup.
	   						<HAddressStruct>getLookup(matchingModeEnum_HAddress);
	   						   
		   	   	   globalMap.put("tHash_Lookup_HAddress", tHash_Lookup_HAddress);
...
/**
 * [tAdvancedHash_HAddress begin ] stop
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_1 = context.path_harm+"Address.csv";
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(context.path_harm+"Address.csv", "ISO-8859-15",";","\n",true,1,0,
					...
					columnIndexWithD_tFileInputDelimited_1 = 0;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								HAddress.AddressID = ParserUtils.parseTo_int(temp);
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"AddressID", "HAddress", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
    							
						} else {						
							
								rowstate_tFileInputDelimited_1.setException(new RuntimeException("Value is empty for column : 'AddressID' in 'HAddress' connection, value is invalid or this column should be nullable or have a default value."));
					...
					columnIndexWithD_tFileInputDelimited_1 = 1;
							...
							HAddress.AddressLine1 = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 2;
					
							HAddress.AddressLine2 = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 3;
					
							HAddress.City = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 4;
					
							HAddress.StateProvince = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 5;
					
							HAddress.CountryRegion = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 6;
					
							HAddress.PostalCode = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 7;
					
							HAddress.rowguid = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
					...
					columnIndexWithD_tFileInputDelimited_1 = 8;
						...
						if(temp.length() > 0) {
								...
								try {
    									...
    									HAddress.ModifiedDate = ParserUtils.parseTo_Date(temp, "dd-MM-yyyy");
    								
    							} catch(java.lang.Exception ex_tFileInputDelimited_1) {
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ModifiedDate", "HAddress", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
    							
						} else {						
							
								
									HAddress.ModifiedDate = null;
...
if(HAddress != null) { 
	...
	/**
	 * [tAdvancedHash_HAddress main ] start
	 */
	...
	currentComponent="tAdvancedHash_HAddress";
					...
					HAddressStruct HAddress_HashRow = new HAddressStruct();
		   	   	   
				
				HAddress_HashRow.AddressID = HAddress.AddressID;
				
				HAddress_HashRow.AddressLine1 = HAddress.AddressLine1;
				
				HAddress_HashRow.AddressLine2 = HAddress.AddressLine2;
				
				HAddress_HashRow.City = HAddress.City;
				
				HAddress_HashRow.StateProvince = HAddress.StateProvince;
				
				HAddress_HashRow.CountryRegion = HAddress.CountryRegion;
				
				HAddress_HashRow.PostalCode = HAddress.PostalCode;
				
				HAddress_HashRow.rowguid = HAddress.rowguid;
				
				HAddress_HashRow.ModifiedDate = HAddress.ModifiedDate;
				
			tHash_Lookup_HAddress.put(HAddress_HashRow);
	...
	tos_count_tAdvancedHash_HAddress++;

/**
 * [tAdvancedHash_HAddress main ] stop
 */
	
	/**
	 * [tAdvancedHash_HAddress process_data_begin ] start
	 */
...
/**
 * [tAdvancedHash_HAddress process_data_begin ] stop
 */
	
	/**
	 * [tAdvancedHash_HAddress process_data_end ] start
	 */
...
/**
 * [tAdvancedHash_HAddress process_data_end ] stop
 */

} // End of branch "HAddress"
 ...
 */
	...
	/**
	 * [tAdvancedHash_HAddress end ] start
	 */
...
tHash_Lookup_HAddress.endPut();

				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"HAddress");
			  	}
			  	
 

ok_Hash.put("tAdvancedHash_HAddress", true);
end_Hash.put("tAdvancedHash_HAddress", System.currentTimeMillis());




/**
 * [tAdvancedHash_HAddress end ] stop
 */
 ...
 */
	...
	/**
	 * [tAdvancedHash_HAddress finally ] start
	 */
...
/**
 * [tAdvancedHash_HAddress finally ] stop
 */
    ...
    public static void main(String[] args){
        final CURATED_V2 CURATED_V2Class = new CURATED_V2();

        int exitCode = CURATED_V2Class.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = CURATED_V2.class.getClassLoader().getResourceAsStream("local_project/curated_v2_0_2/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = CURATED_V2.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : CURATED_V2");
        }
