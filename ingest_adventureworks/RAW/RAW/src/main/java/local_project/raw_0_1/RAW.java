...
public static class AddressStruct implements routines.system.IPersistableRow<AddressStruct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_RAW = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_RAW = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LOCAL_PROJECT_RAW.length) {
				if(length < 1024 && commonByteArray_LOCAL_PROJECT_RAW.length == 0) {
   					commonByteArray_LOCAL_PROJECT_RAW = new byte[1024];
				} else {
   					commonByteArray_LOCAL_PROJECT_RAW = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LOCAL_PROJECT_RAW, 0, length);
			strReturn = new String(commonByteArray_LOCAL_PROJECT_RAW, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_LOCAL_PROJECT_RAW, 0, length);
			strReturn = new String(commonByteArray_LOCAL_PROJECT_RAW, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_PROJECT_RAW) {
                    ...
                    if(directory_tFileOutputDelimited_12 != null && directory_tFileOutputDelimited_12.trim().length() != 0) {
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_12, false),"ISO-8859-15"));
                                    if(filetFileOutputDelimited_12.length()==0){
                                        outtFileOutputDelimited_12.write("ProductCategoryID");
                                            outtFileOutputDelimited_12.write(OUT_DELIM_tFileOutputDelimited_12);
                                        outtFileOutputDelimited_12.write("ParentProductCategoryID");
                                            outtFileOutputDelimited_12.write(OUT_DELIM_tFileOutputDelimited_12);
                                        outtFileOutputDelimited_12.write("Name");
                                            outtFileOutputDelimited_12.write(OUT_DELIM_tFileOutputDelimited_12);
                                        outtFileOutputDelimited_12.write("rowguid");
                                            outtFileOutputDelimited_12.write(OUT_DELIM_tFileOutputDelimited_12);
                                        outtFileOutputDelimited_12.write("ModifiedDate");
 ...
 */
	...
	currentComponent="tDBInput_6";
		...
		int tos_count_tDBInput_6 = 0;
		    ...
		    String dbquery_tDBInput_6 = "SELECT \n		SalesLT.ProductDescription.ProductDescriptionID,\n		replace(replace(replace(replace(cast(SalesLT.ProductDesc"
+"ription.Description as nvarchar(max)), char(32), ''),  char(13), ''),  char(10), ''), ';', '') as Description,\n		SalesLT"
 ...
 */
	...
	currentComponent="tDBInput_7";
		...
		int tos_count_tDBInput_7 = 0;
		    ...
		    String dbquery_tDBInput_7 = "SELECT SalesLT.ProductModel.ProductModelID,\n		SalesLT.ProductModel.Name,\n		replace(replace(replace(replace(cast(SalesL"
+"T.ProductModel.CatalogDescription as nvarchar(max)), char(32), ''),  char(13), ''),  char(10), ''), ';', '') as CatalogD"
+"escription,\n		SalesLT.ProductModel.rowguid,\n		SalesLT.ProductModel.ModifiedDate\nFROM	SalesLT.ProductModel";
		    ...
		    while (rs_tDBInput_7.next()) {
		        nb_line_tDBInput_7++;
							...
							if(colQtyInRs_tDBInput_7 < 1) {
								row2.ProductModelID = 0;
							} else {
		                          
            row2.ProductModelID = rs_tDBInput_7.getInt(1);
            ...
            if(tmpContent_tDBInput_7 != null) {
            	if (talendToDBList_tDBInput_7 .contains(rsmd_tDBInput_7.getColumnTypeName(2).toUpperCase(java.util.Locale.ENGLISH))) {
            		row2.Name = FormatterUtils.formatUnwithE(tmpContent_tDBInput_7);
            	} else {
                	row2.Name = tmpContent_tDBInput_7;
                }
            } else {
                row2.Name = null;
            }
            ...
            if(tmpContent_tDBInput_7 != null) {
            	if (talendToDBList_tDBInput_7 .contains(rsmd_tDBInput_7.getColumnTypeName(3).toUpperCase(java.util.Locale.ENGLISH))) {
            		row2.CatalogDescription = FormatterUtils.formatUnwithE(tmpContent_tDBInput_7);
            	} else {
                	row2.CatalogDescription = tmpContent_tDBInput_7;
                }
            } else {
                row2.CatalogDescription = null;
            }
            ...
            row2.rowguid = rs_tDBInput_7.getObject(4);
            if(rs_tDBInput_7.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
			...
			row2.ModifiedDate = mssqlGTU_tDBInput_7.getDate(rsmd_tDBInput_7, rs_tDBInput_7, 5);
	...
	currentComponent="tFileOutputDelimited_7";
                    ...
                    StringBuilder sb_tFileOutputDelimited_7 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_7.append(
                            ...
                            sb_tFileOutputDelimited_7.append(OUT_DELIM_tFileOutputDelimited_7);
                            if(row2.CatalogDescription != null) {
                        sb_tFileOutputDelimited_7.append(
                            row2.CatalogDescription
                        );
                            }
                            sb_tFileOutputDelimited_7.append(OUT_DELIM_tFileOutputDelimited_7);
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = RAW.class.getClassLoader().getResourceAsStream("local_project/raw_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
